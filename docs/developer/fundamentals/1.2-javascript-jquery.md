...
For example loading AngularJS via a CDN, from [Adding stylesheets (CSS) and JavaScript (JS) to a Drupal 8 theme](//drupal.org/docs/8/theming-drupal-8/adding-stylesheets-css-and-javascript-js-to-a-drupal-8-theme):
...
You can use [hooks](//api.drupal.org/api/drupal/core%21core.api.php/group/hooks/8.2.x) to add conditionally.
...
code runs on normal page loads, ajax calls and inside [BigPipe](//drupal.org/docs/8/core/modules/bigpipe/overview).
...
Example from [Javascript API Overview](//drupal.org/docs/8/api/javascript-api/javascript-api-overview):
...
> [!NOTE]
> `@count` is a special placeholder and does need to be defined in your variable array, like `@type` does.
> Additionally `@count` should never be used in the singular string, only the plural.
<!-- prettier-ignore-end -->
...
- [drupal.org: Adding stylesheets (CSS) and JavaScript (JS) to a Drupal 8 theme](//drupal.org/docs/8/theming-drupal-8/adding-stylesheets-css-and-javascript-js-to-a-drupal-8-theme)
- [drupal.org: Adding stylesheets (CSS) and JavaScript (JS) to a Drupal 8 module](//drupal.org/docs/8/creating-custom-modules/adding-stylesheets-css-and-javascript-js-to-a-drupal-8-module)
- [drupal.org: Javascript API Overview](//drupal.org/docs/8/api/javascript-api/javascript-api-overview)
- [developer.mozilla.org - Strict mode](//developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Strict_mode)
- [docs.microsoft.com - Strict Mode (JavaScript)](//docs.microsoft.com/en-us/scripting/javascript/advanced/strict-mode-javascript)
